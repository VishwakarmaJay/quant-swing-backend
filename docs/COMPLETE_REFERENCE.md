...
**448 tests, typecheck clean.** The strategy has been improved from clearly losing to near-breakeven **but has no
...
2026-07-20]** 448 tests + golden gate green; whole stack deployed on AWS
